...
if (form) {
    form.addEventListener('submit', function(event) 
    {
        ...
        if (isValid) {
            ...
            AddSongLibrary.addSong(new AddSong(songNameValue, songFileValue));
            console.log(AddSongLibrary.Songs);
...
window.AddSongLibrary = AddSongLibrary;