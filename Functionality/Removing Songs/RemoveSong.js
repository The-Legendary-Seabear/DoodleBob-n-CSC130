...
{
    RemoveSongLibrary.loadSongs();
    selectElement.innerHTML = '';

    if (RemoveSongLibrary.Songs.length === 0) {
    ...
    RemoveSongLibrary.Songs.forEach(song => {
        const option = document.createElement('option');
...
document.addEventListener('DOMContentLoaded', function()
{
    ...
    form.addEventListener('submit', function(event)
    {
        ...
        const wasRemoved = RemoveSongLibrary.removeSong(selectedSongName);
...
window.RemoveSongLibrary = RemoveSongLibrary;
